  ...
  return (
    <>
      ...
      <Container className="w-[78rem] max-w-[90%] text-center">
        ...
        <hr className="mb-[7.2rem] h-[1.5px] border-none bg-[linear-gradient(to_right,transparent,rgba(255,255,255,0.1)_50%,transparent)]" />
      </Container>
    </>
  );
};
