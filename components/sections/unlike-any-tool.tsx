...
import { KeyboardShortcuts } from "../keyboard-sortcuts";

export const UnlikeAnyTool = () => (
  <div className="text-white  max-w-[120rem] mx-auto">
    <Container>
    ...
    <div className="h-[48rem] overflow-hidden md:h-auto md:overflow-auto">
      ...
      <div className="group relative flex min-h-[48rem] w-full shrink-0 snap-center flex-col items-center justify-end overflow-hidden rounded-[4.8rem] border border-transparent-white bg-glass-gradient p-8 text-center md:basis-[calc(33.33%-12px)] md:p-14">
        ...
        <Button
          className="absolute bottom-[20rem] translate-y-[30%] scale-[0.8] opacity-0 transition-[transform,opacity] group-hover:transform-none group-hover:opacity-100 [&_.icon-wrapper]:text-[1.1rem] whitespace-nowrap"
          variant="secondary"
          size="small"
          href="/"
        >
