...
export const HeroImage = () => {
  ...
  useEffect(() => {
    ...
    const renderLine = (timeout: number) => {
        ...
        renderLine(randomNumberBetween(200, 2000));
      }, timeout);
    };
    ...
    <div ref={ref} className="mt-[12.8rem] [perspective:2000px] ">
      <div
        className={classNames(
          "relative rounded-xl border border-transparent-white bg-white bg-opacity-[0.01] bg-hero-gradient",
          inView ? "animate-image-rotate" : "[transform:rotateX(25deg)]",
          "before:absolute before:opacity-0 before:top-0 before:left-0 before:h-full before:w-full before:bg-hero-glow             before:[filter:blur(120px)]",
          inView && "before:animate-image-glow"
        )}
      >
        {/* acest div este pus ca liniile animate sa nu mai iasa/depaseasca din/ containarul imagini */}
       <div className="rounded-xl overflow-hidden absolute top-0 left-0   h-full w-full">
        ...
        <img
          className={classNames(
            "relative z-10 transition-opacity delay-[680ms] rounded-xl",
